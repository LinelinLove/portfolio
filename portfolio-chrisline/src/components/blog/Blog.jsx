      ...
      <div className="blog__container grid">
        ...
        <div className="blog__card">
          <div className="blog__thumb">
            ...
            <a href="#"><img src={Image1} alt="Image blog" className="blog__img" /></a>
          </div>
        ...
        <div className="blog__card">
          <div className="blog__thumb">
            ...
            <a href="#"><img src={Image2} alt="Image blog" className="blog__img" /></a>
          </div>
        ...
        <div className="blog__card">
          <div className="blog__thumb">
            ...
            <a href="#"><img src={Image3} alt="Image blog" className="blog__img" /></a>
          </div>
